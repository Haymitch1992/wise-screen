  ...
  <div>
    ...
    <div class="screen-C">
      ...
      <div class="screen-item  exit-block">
        ...
        <img class="distance-img" src="../assets/distance-left-1.gif" alt="" />
        <span class="distance-text">10m</span>
        <img src="../assets/exit-A.png" alt="" />
        <img class="margin-icon" src="../assets/exit-B.png" alt="" />
        <div class="screent-text-block">
          <p>出口</p>
          <p class="text">Exit</p>
        </div>
        <img src="../assets/stairs-1.png" alt="" />
      </div>
    </div>
    <broadcast></broadcast>
    <recognition-box v-if="this.$store.state.showTips"></recognition-box>
  </div>
</template>
...
import recognitionBox from '../components/recognitionBox.vue';
export default {
  components: {
    broadcast,
    headerbox,
