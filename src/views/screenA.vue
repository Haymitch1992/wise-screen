                ...
                <div>
                    ...
                    <div class="screen-bottom">
                        <div class="screen-bottom-item">
                            <p class="text-1">开往上芬</p>
                            <p class="text-2">To SHANGFEN</p>
                            <p class="text-3">1分钟（Min）</p>
                        </div>
                        <div class="screen-bottom-item">
                            <p class="text-1">开往深圳北站</p>
                            <p class="text-2">To Shenzhen North Station</p>
